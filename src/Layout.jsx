...
const SELF_CONTAINED_PUBLIC_PAGES = [
  ...
  'ArchivedMembers', 'GoldAwardDetail', 'SilverAwardDetail', 'IdeasBoard', 'AIProgrammePlanner',
  'ConsentForms', 'ConsentFormBuilder', 'SectionAccounting', 'AdminSettings',
  'ParentDashboard', 'MyChild', 'ParentProgramme', 'ParentEvents',
  'ParentEventDetail', 'ParentBadges', 'ParentGoldAward', 'ParentSilverAward', 'ParentBronzeAward', 'ParentPortal',
  'BronzeAwardDetail',
  'ParentPortalAnalytics', 'PORHelper', 'RiskAssessments',
  'JoiningInBadgeDetail', 'NightsAwayBadgeDetail', 'HikesAwayBadgeDetail',
  'StagedBadgeDetail', 'GoldAwardDetail', 'WhatsAppSchedules', 'WhatsAppTemplates',
];
