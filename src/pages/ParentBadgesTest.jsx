...
import TestAwardPanel from '../components/parent/badgestest/TestAwardPanel';
import TestEarnedPanel from '../components/parent/badgestest/TestEarnedPanel';
import TestActivityAwards from '../components/parent/badgestest/TestActivityAwards';
import TestAllBadges from '../components/parent/badgestest/TestAllBadges';

export default function ParentBadgesTest() {
  ...
  // ── Progress helpers (same rules as the live badges page) ──────────────────
  ...
  // ── Bottom: all badges list (challenge, staged families, core, activity) ───
  const allItems = [
    ...singleBadges.map(b => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-10 gap-6">
          ...
          <div className="lg:col-span-7">
            <TestEarnedPanel earnedChallenge={earnedChallenge} earnedStaged={earnedStaged} />
          </div>
        </div>

        {/* Nights away / Hikes away / Joining In */}
        <TestActivityAwards groups={activityGroups} />

        {/* All badges with filter */}
        <TestAllBadges items={allItems} />

        <Card className="border-dashed border-2 border-purple-200 bg-purple-50/50 shadow-none">
          <CardContent className="p-4">
            <p className="text-xs text-purple-700">
              <strong>Test page</strong> — the live badges page is untouched. Badge tiles here aren't clickable yet;
              detail popups will be wired in once the layout is approved.
            </p>
          </CardContent>
        </Card>
      </div>
