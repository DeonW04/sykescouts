...
export default function RegisterUser() {
  ...
  useEffect(() => {
    ...
    base44.functions.invoke('validateUserInvite', { token })
      .then((res) => {
  ...
  if (!invite) {
    const messages = {
      ...
      expired: 'This invitation has expired. Please ask an administrator to send a new one.',
    ...
    <div style={pageWrap}>
      ...
      <div style={cardStyle}>
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          ...
          <p style={subStyle}>
            {stage === 'form'
              ? <>Welcome! Set a password to access the 40th Rochdale (Syke) Scouts portal.</>
              : <>We've sent a 6-digit code to <strong>{invite.email}</strong>.</>}
          </p>
        </div>
