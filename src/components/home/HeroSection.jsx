...
export default function HeroSection() {
  ...
  return (
    <>
      ...
      <section style={{ position: 'relative', height: 'calc(100dvh + 78px)', minHeight: '600px', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center', marginTop: '-80px', paddingBottom: '0' }}>
        {/* Background images */}
        {images.length > 0 ? (
          <>
            {prevIdx !== null && (
